...
let w_temperature = document.querySelector(".weather_tempreture");
...
const getweatherData = async () => {
  const weatherUrl = `https://api.openweathermap.org/data/2.5/weather?units=metric&q=${city}&APPID=57ac3bdaf0e323102d449ceb6a3750cb`;
  try {
    ...
    w_minTem.innerHTML = `Min: ${main.temp_max.toFixed()}°C`;
